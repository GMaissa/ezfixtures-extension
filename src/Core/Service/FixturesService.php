...
namespace GMaissa\eZFixturesExtension\Core\Service;
...
use GMaissa\eZFixturesExtension\API\DefinitionParserInterface;
use GMaissa\eZFixturesExtension\API\Exception\FixtureStepExecutionException;
...
class FixturesService
{
    ...
    public function __construct(
        FixturesLoaderInterface $loader,
